  ...
  return (
    <div className="min-h-screen bg-dark-bg text-white">
      ...
      <div className="relative py-20 px-6 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-cyberpunk-gradient opacity-10 blur-3xl pointer-events-none" />
            ...
            {items.map((item) => (
              ...
              >
                ...
                >
                  ...
                  {/* 情報エリア */}
                  <div className="p-5">
                    <h3 className="font-bold text-lg mb-2 line-clamp-2 min-h-[3.5rem] text-white group-hover:text-neon-cyan transition-colors">
                      {item.title}
                    </h3>
